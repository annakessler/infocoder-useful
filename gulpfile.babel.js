...
import { otfToTtf, ttfToWoff2, transferWoff2 } from './gulp/tasks/fonts';
...
function watcher() {
	...
	gulp.watch(path.watch.fonts, otfToTtf);
	gulp.watch(path.watch.fonts, ttfToWoff2);
	gulp.watch(path.watch.fonts, transferWoff2);
}

const fonts = gulp.series(otfToTtf, ttfToWoff2, transferWoff2);
